...
def main():
    ...
    parser.add_argument('--model_path', default='D:\桌面\SpongeBobPro\pretrain_768.pth', type=str, help="模型权重路径（.pth文件）")
    ...
    model.load_state_dict(torch.load(args.model_path, map_location=args.device)) # 加载权重
